...
const helpData = [
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                needCK: false,
                needSK: false,
                commands: ['绝境排行', '绝境排名', '危局绝境排行', '危局绝境排名', '强袭战绝境排行'],
            },
            {
                title: '查看拟境湮灭战排名',
                desc: '查看拟境湮灭战群排名',
    ...
    },
    {
        ...
        items: [
            ...
            {
                title: '设置全局提醒阈值',
                desc: '设置全局默认防卫战检查层数阈值(0~6)，或全局默认危局强袭战星星阈值(0~9)，0为不提醒',
                needCK: true,
                needSK: false,
            ...
            {
                title: '设置提醒阈值',
                desc: '设置防卫战检查层数阈值(0~6)，或危局强袭战星星阈值(0~9)，0为不提醒。例如：设置危局阈值6',
                needCK: true,
                needSK: false,
            ...
            {
                title: '查看提醒状态',
                desc: '查看个人提醒时间、提醒开关状态和提醒阈值，或全局提醒时间',
                needCK: true,
                needSK: false,
                commands: ['个人提醒状态', '个人提醒时间', '全局提醒时间']
            },
            {
                title: '重置个人提醒时间',
